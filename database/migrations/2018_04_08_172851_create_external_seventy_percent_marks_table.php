...
class CreateExternalSeventyPercentMarksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('external_seventy_percent_marks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('external_seventy_percent_marks');
    }
}
