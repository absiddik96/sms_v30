...
class CreateThirdExaminerSeventyMarksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('third_examiner_seventy_marks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('third_examiner_seventy_marks');
    }
}
