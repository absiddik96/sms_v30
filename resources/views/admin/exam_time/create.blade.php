    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="{{ route('exam-time.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" pattern="\d*" maxlength="4" name="exam_year" class="form-control" value="{{ old('exam_time') }}">
                        </div>
                    </div>
