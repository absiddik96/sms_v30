...
@section('content')
  <div class="col-sm-12">
      ...
      <div class="col-sm-12 text-center">
        <h3><u>Tabulation Sheet For</u></h3>
          ...
          <tr>
            ...
            <td style="padding-top:5px;font-weight:bold">Name of the Students</td>
                @foreach ($courses as $c)
                  <td>
                      <p style="min-height:50px;max-height:100px;font-weight:bold">{{$c->name}}</p>
                      <p class="border_top">{{$c->code}}</p>
                      <p class="border_top">{{$c->mark}}</p>

                        <table class="table border_top inner_table" style="margin-bottom: 0;">
                          <tr>
                              <td width="50%" style="padding:5px;">Marks</td>
            ...
            @foreach ($full_results as $roll => $course_results)
                <tr>
                    ...
                    <td style="padding:5px">{{$course_results['result'][0]->name}}</td>
...
<a class="btn btn-primary btn-sm" href="{{route('pdf.charman-result-with-mark.show',[$exam_id,$semester->id])}}">With Mark PDF</a>
<br><br><br><br>
@endsection
