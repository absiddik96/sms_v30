	...
	<div class="col-sm-12">
		...
		<div class="col-md-7">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{!! Form::model($thirty_per_mark,['route' => [$route,$thirty_per_mark->id] ,'method'=>'put','class'=>'form-horizontal','id'=>'myform']) !!}
		                @include('includes.errors')
						<div class="form-group">
							{!! Form::label('tutorial_1','Tutorial 1', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-6">
								{!! Form::number('tutorial_1',null, ['class'=>'form-control itpm','id'=>'tutorial_1','min'=>0,'max'=>10]) !!}
							</div>
						</div>
						<div class="form-group">
							{!! Form::label('tutorial_2','Tutorial 2', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-6">
								{!! Form::number('tutorial_2',null, ['class'=>'form-control itpm','id'=>'tutorial_2','min'=>0,'max'=>10]) !!}
							</div>
						</div>
						<div class="form-group">
							{!! Form::label('tutorial_3','Tutorial 3', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-6">
								{!! Form::number('tutorial_3',null, ['class'=>'form-control itpm','id'=>'tutorial_3','min'=>0,'max'=>10]) !!}
							</div>
						</div>
						<div class="form-group">
							{!! Form::label('prefer_tutorial','Prefer Tutorial', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-3">
								{!! Form::select('prefer_tutorial_id', $prefer_tutorial, null, ['class'=>'form-control itpm','id'=>'prefer_tutorial']) !!}
							</div>
							<div class="col-md-3">
								{!! Form::number('prefer_tutorial',null, ['class'=>'readonly_input','readonly'=>'readonly','id'=>'pt_result']) !!}
							</div>
						</div>
						<div class="form-group">
							{!! Form::label('mid_term','Mid-term', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-6">
								{!! Form::number('mid_term',null, ['class'=>'form-control itpm','id'=>'mid_term','min'=>0,'max'=>10]) !!}
							</div>
						</div>
						<div class="form-group">
							{!! Form::label('attendance','Attendance', ['class'=>'control-label col-md-3']) !!}
							<div class="col-md-6">
								{!! Form::number('attendance',null, ['class'=>'form-control itpm','id'=>'attendance','min'=>0,'max'=>10]) !!}
							</div>
						</div>
						<div class="form-group">
