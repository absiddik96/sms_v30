        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-body" style="padding-bottom: 0;">
                    <div class="col-sm-3">
                        <p><a style="width:100%" class="btn btn-default text-center" href="{{route('internal.result.thirty.show', ['course_e_id'=>$course_e->id,'semester_id'=>$course_e->semester_id])}}">Thirty Percent Marks</a></p>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a class="btn btn-primary" href="{{ route('pdf.internal-seventy-percetn-mark',$course_e->id) }}">70 PDF</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($results as $result)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-info " href="{{ route('internal.seventy-percetn-mark.edit',['course_e_id'=>$course_e->id,'student_id'=>$result['student']->id]) }}">Edit </a>
                                    </td>
                                </tr>
                            @endforeach
                            {{-- @foreach ($student_enrolls as $student_enroll)
                                <tr>
                                    ...
                                    <td>{{ $student_enroll->seventyMark['q_1'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_2'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_3'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_4'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_5'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_6'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_7'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_8'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_9'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_10'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_11'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_12'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_13'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_14'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['q_15'] }}</td>
                                    <td>{{ $student_enroll->seventyMark['total'] }}</td>
                                    <td class="text-center">
                                        <a class="btn btn-info " href="{{ route('internal.seventy-percetn-mark.edit',['course_e_id'=>$course_e->id,'student_id'=>$student_enroll->student->id]) }}">Edit </a>
                                    </td>
                                </tr>
                            @endforeach --}}
