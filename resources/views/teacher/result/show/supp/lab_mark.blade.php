        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Process Supplementary Lab Result</h4>
                </div>
                        ...
                        <tbody>
                            @foreach ($results as $se)
                                <tr>
                                    ...
                                    <td>{{ $se['result']->tutorial }}</td>
                                    <td>{{ $se['result']->mid_term }}</td>
                                    <td>{{ $se['result']->attendance }}</td>
                                    <td>{{ $se['result']->lab_seventy_mark }}</td>
                                    <td>{{ $se['result']->total }}</td>
                                    <td class="text-center">
                                        <a class="btn btn-info " href="{{ route('internal.supp-lab-mark.edit',['supp_e_id'=>$se['student']->id,'student_id'=>$se['student']->student_id]) }}">Edit </a>
                                    </td>
                                </tr>
                            @endforeach
