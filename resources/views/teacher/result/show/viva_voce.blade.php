        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Process Viva Voce Result</h4>
                </div>
                            ...
                            @foreach ($results as $result)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-info " href="{{ route('internal.viva-voce-mark.edit',['course_e_id'=>$course_e->id,'student_id'=>$result['student']->id]) }}">Edit </a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
