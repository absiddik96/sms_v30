	...
	<div class="col-sm-12">
		...
		<div class="col-md-7">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{!! Form::model($supp_mark,['route' => [$route,$supp_mark->id] ,'method'=>'put','class'=>'form-horizontal','id'=>'myform']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								{!! Form::number('total',null, ['class'=>'readonly_input','readonly'=>'readonly','id'=>'total','min'=>0,'max'=>70]) !!}
							</div>
						</div>
